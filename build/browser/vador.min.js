...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var s=0;s<t.length;s++){var r=t[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,s,r){return s&&e(t.prototype,s),r&&e(t,r),t}}(),_http=require("./http"),_restResource=require("./restResource"),_lodashAssign=require("lodash.assign"),_lodashAssign2=_interopRequireDefault(_lodashAssign),RestClient=function(){function e(t){var s=void 0===arguments[1]?{}:arguments[1];_classCallCheck(this,e),this._baseUrl=t,this._interceptors=s.interceptors||[],this._headers=s.headers||{},this._http=s.http||null,this._cache={}}return _createClass(e,[{key:"baseUrl",set:function(e){this._baseUrl=e}},{key:"addHeader",value:function(e,t){this._headers[e]=t}},{key:"http",set:function(e){this._http=e}},{key:"addInterceptor",value:function(e){var t=void 0===arguments[1]?!0:arguments[1];t?this._interceptors.push(e):this._interceptors.unshift(e)}},{key:"resource",value:function(e){var t=void 0===arguments[1]?{}:arguments[1];if(!this._cache[e]){var s=_lodashAssign2["default"]({},this._config,t);s.defaultHeaders=_lodashAssign2["default"]({},this._headers,t.defaultHeaders||{}),s.interceptors=(t.interceptors||[]).concat(this._interceptors),s.http||(s.http=this._http),this._cache[e]=new _restResource.RestResource(this._baseUrl,e,t)}return this._cache[e]}}]),e}();exports.RestClient=RestClient;
